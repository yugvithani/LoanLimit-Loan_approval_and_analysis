...
//     username: 'downtown-mumbai@manager', 
//     password: '123456', 
//   });
...
const LoginNotification = () => {
  return (
    <div className="bg-green-500/20 border-2 border-green-500 rounded-md p-4 mb-6 shadow-md text-center animate-pulse">
      <p className="text-green-100 font-semibold mb-1">
        ✨ <span className="text-white">Hackathon Demo</span> ✨
      </p>
      <p className="text-green-100">
        Login credentials are already pre-filled for convenience.
        <br />
        <span className="font-bold text-white">Simply click the Access Dashboard button to continue!</span>
      </p>
    </div>
  );
};
      ...
      <div className="w-full lg:w-1/2 flex justify-center items-center p-6">
        <div className="w-full max-w-md">
          ...
          >
            ...
            {/* Always show the notification when page loads */}
            <LoginNotification />
